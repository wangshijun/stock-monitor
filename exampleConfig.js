...
Required Variables:
  ...
  stocks:             StatsD listening port [default: 8125]
...
OpenTSDB Required Variables:

(Leave these unset to avoid sending stats to OpenTSDB.
 Set debug flag and leave these unset to run in 'dry' debug mode -
 useful for testing statsd clients without a OpenTSDB server.)

  opentsdbHost:     hostname or IP of OpenTSDB server
  opentsdbPort:     port of OpenTSDB server
  opentsdbTagPrefix: prefix for opentsdb tag prefix, default "tag."
...
Optional Variables:
  ...
  flushOnTime:      flush at certain time, like a cron job, default false, can be specified use '10:00', '*:20'
  bypassAggregator: whether bypass built in stats aggregator [default: false]
  ...
  disabledStats:    an array of stats to not calculate and send [default: false]
                    this is commonly used to save as many calculation time and network traffice as we can
                    also useful to exclude those non-interest stats, such as mean_*, sum_*
